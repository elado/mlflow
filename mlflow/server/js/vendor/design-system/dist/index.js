...
const TableRow = /*#__PURE__*/forwardRef(function TableRow(_ref2, ref) {
  let {
    children,
    className,
    style,
...
const TableCell = /*#__PURE__*/forwardRef(function (_ref3, ref) {
  let {
    children,
    className,
    ellipsis = false,
...
const TableHeader = /*#__PURE__*/forwardRef(function TableHeader(_ref4, ref) {
  let {
    children,
    ellipsis = false,
    sortable,
  ...
  return jsxs("div", {
    ...
    children: [sortable && !isResizing ? jsxs("div", {
      ...
      children: [textContents, jsx("span", {
        ...
        css: [tableStyles.sortHeaderIcon, process.env.NODE_ENV === "production" ? "" : ";label:TableHeader;"],
        children: sortIcon
      })]
    }) : textContents, resizeHandle]
  });
});
const TableHeaderResizeHandle = /*#__PURE__*/forwardRef(function TableHeaderResizeHandle(_ref5, ref) {
  let {
    style,
    resizeHandler,
    children,
...
const TableRowSelectCell = /*#__PURE__*/forwardRef(function TableRowSelectCell(_ref6, ref) {
  let {
    onChange,
    checked,
    indeterminate,
